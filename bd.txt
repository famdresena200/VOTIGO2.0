...
DROP TABLE IF EXISTS ELECTEURS_AUTORISES;
...
CREATE TABLE USERS (
    ...
    UNIQUE KEY ux_users_nen (nen),
    UNIQUE KEY ux_users_cin (cin)
...
CREATE TABLE ELECTEURS_AUTORISES (
    ...
    UNIQUE KEY ux_electeurs_autorises_cin (cin),
    UNIQUE KEY ux_electeurs_autorises_nen (nen)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
-- Correction : supprimer colonne id_user si elle existe
ALTER TABLE VOTES DROP COLUMN IF EXISTS id_user;
