...
$login_mode = isset($_SESSION['user_id']) && !$reset_mode;
...
// If login mode (not reset), redirect to main page
if ($login_mode && !$reset_mode) {
    header("Location: ../contenue/page_principale.php");
    exit;
}
...
<head>
    ...
    <title>VOTIGO - Réinitialiser Mot de Passe</title>
    ...
    <div class="container">
        <div class="topbar">
            ...
            <div class="progressbar" role="navigation" aria-label="Progression">
                <div class="step done"><div class="dot">1</div><div>Réinitialisation</div></div>
                <div class="step done"><div class="dot">2</div><div>Vérification</div></div>
                <div class="step active"><div class="dot">3</div><div>Nouveau mot de passe</div></div>
            </div>
        ...
        <section class="card">
            <div class="form">
                ...
                <div class="muted">Étape 3 sur 3 : Créez un nouveau mot de passe sécurisé</div>
                ...
                <form method="post" id="passwordForm">
                    ...
                    <div class="actions">
                        ...
                        <a href="login.php"><button type="button" class="btn ghost">Retour</button></a>
                    </div>
                </form>
            </div>
